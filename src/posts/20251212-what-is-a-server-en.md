...
<table class="not-prose w-full text-sm">
  <thead>
    <tr>
      <th>Service</th>
      <th>Example of Server Type Behind It</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Viewing a website</td>
      <td>Web server (like Apache or Nginx) </td>
    </tr>
    <tr>
      <td>Sending/receiving email</td>
      <td>Mail server (SMTP/IMAP) </td>
    </tr>
    <tr>
      <td>Sharing files at work</td>
      <td>File server (e.g., NAS, Windows Server)</td>
    </tr>
  </tbody>
</table>

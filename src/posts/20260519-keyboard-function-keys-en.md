...
<table class="not-prose w-full text-sm">
  <thead>
    <tr>
      <th>Key</th>
      <th>Main Function (When Pressed Alone)</th>
      <th>Function in Excel</th>
      <th>Function in Word</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td><kbd>F1</kbd></td>
      <td>Opens the Help menu (common in most software applications)</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td><kbd>F2</kbd></td>
      <td>Renames files or folders (in File Explorer or on the desktop)</td>
      <td>Enters edit mode for the selected cell</td>
      <td>Moves selected text (select text, press <kbd>F2</kbd>, move the cursor, then press Enter)</td>
    </tr>
    <tr>
      <td><kbd>F3</kbd></td>
      <td>Opens the search function (in File Explorer, browsers, and many apps)</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td><kbd>F4</kbd></td>
      <td>Displays the address bar (in File Explorer)<br>Closes the active window (<kbd>Alt</kbd> + <kbd>F4</kbd>)</td>
      <td>Repeats the last action (such as formatting)<br>Toggles cell references between absolute and relative in formulas</td>
      <td></td>
    </tr>
    <tr>
      <td><kbd>F5</kbd></td>
      <td>Refreshes the page or updates content (commonly used in browsers and File Explorer)</td>
      <td>Opens the Go To dialog for quick navigation</td>
      <td>Opens the Go To dialog for quick navigation</td>
    </tr>
    <tr>
      <td><kbd>F6</kbd></td>
      <td>Selects the address bar in browsers<br>Converts Japanese input to Hiragana</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td><kbd>F7</kbd></td>
      <td>Converts Japanese input to full-width Katakana</td>
      <td>Runs spell check</td>
      <td>Runs spelling and grammar check</td>
    </tr>
    <tr>
      <td><kbd>F8</kbd></td>
      <td>Converts Japanese input to half-width Katakana</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td><kbd>F9</kbd></td>
      <td>Converts Japanese input to full-width alphanumeric characters</td>
      <td>Recalculates all formulas in the workbook</td>
      <td></td>
    </tr>
    <tr>
      <td><kbd>F10</kbd></td>
      <td>Converts Japanese input to half-width alphanumeric characters</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td><kbd>F11</kbd></td>
      <td>Toggles full-screen mode (in browsers and many applications)</td>
      <td></td>
      <td></td>
    </tr>
    <tr>
      <td><kbd>F12</kbd></td>
      <td>Opens Developer Tools (DevTools) in browsers</td>
      <td>Opens the Save As dialog</td>
      <td>Opens the Save As dialog</td>
    </tr>
  </tbody>
</table>

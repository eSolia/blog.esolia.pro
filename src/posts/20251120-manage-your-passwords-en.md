...
<table class="not-prose w-full text-sm">
  ...
  <tbody>
    <tr>
      <td>esolia</td>
      <td>es0li@/ esoL1a</td>
      <td>replace letters with similar symbols or numbers</td>
    </tr>
    <tr>
      <td>esolia123</td>
      <td>esoLiA!123</td>
      <td>add uppercase, symbols, and numbers</td>
    </tr>
    <tr>
      <td>esolia2024</td>
      <td>esolia-OSUSHI-77-!</td>
      <td>combine with unrelated words and numbers</td>
    </tr>
  </tbody>
</table>

...
date: 2025-11-20T01:28:00.000Z
last_modified: 2025-11-20T10:28:00.000Z
...
**起動方法**
<kbd>Windows</kbd> + <kbd>.（ピリオド）</kbd> または <kbd>Windows</kbd> + <kbd> ;（セミコロン） </kbd>
...
**起動方法**
1. エクスプローラーを開く  
   タスクバーのファイルアイコンをクリック、または <kbd>Windows</kbd> + <kbd>E</kbd>
2. 上部のタブバーの「+」をクリック

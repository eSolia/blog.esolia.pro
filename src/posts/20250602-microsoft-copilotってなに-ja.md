...
例えば、弊社ブログ記事「UTPケーブル? Catケーブル？RJ45コネクタ？Admin 担当者が不思議に思ったIT用語をAIに聞いてみた」では、最初のプロンプトは「**UTPケーブルって何**」、その次にプロンプトを「**UTPケーブル、Catケーブル、RJ45コネクタって何？ＩＴ知識のない人にわかりやすく説明してほしい**」と聞いてみました。 
